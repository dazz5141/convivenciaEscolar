...
@section('title', 'Documentos Adjuntos – Bitácora de Incidentes')

@section('content')

<div class="page-header d-flex justify-content-between align-items-center flex-wrap">
    <div>
        <h1 class="page-title">Documentos del Incidente</h1>
        <p class="text-muted">Gestione los documentos asociados al incidente.</p>
    </div>

    <a href="{{ route('convivencia.bitacora.show', $incidente->id) }}" 
...
<div class="card mb-4 shadow-sm">
    ...
    <div class="card-body">
        <form action="{{ route('convivencia.bitacora.documentos.store', $incidente->id) }}"
              method="POST" 
            ...
            <div class="mb-3">
                ...
                <small class="text-muted">
                    Formatos permitidos: PDF, JPG, PNG, DOC, DOCX (máx. 10 MB)
                </small>
            </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{ route('convivencia.bitacora.documentos.disable', [$incidente->id, $doc->id]) }}"
                                          method="POST">
                                        @csrf
                                        @method('PUT')
