...
@section('title', 'Detalle del Conflicto Entre Funcionarios')
...
<div class="row g-4">
    ...
    <div class="col-lg-8">
        ...
        <div class="form-section">
            ...
            <div class="detail-item">
                <div class="detail-label">Funcionario denunciado:</div>
                <div class="detail-value">
            ...
            {{-- ACUERDOS PREVIOS --}}
            <div class="detail-item">
                <div class="detail-label">Acuerdos previos:</div>
                <div class="detail-value">
                    {!! $conflicto->acuerdos_previos
                        ? nl2br(e($conflicto->acuerdos_previos))
            ...
            <div class="detail-item">
                ...
                <div class="detail-value">
                    @if($conflicto->confidencial)
                        <span class="text-danger fw-bold"><i class="bi bi-lock-fill me-1"></i> Sí</span>
                    @else
