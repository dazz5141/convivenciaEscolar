...
{{-- =========================================================
     PERMISO: SOLO PUEDE EDITAR QUIEN TENGA editar_accidente
========================================================= --}}
@if (canAccess('accidentes', 'edit'))
    {{-- PERMISO: puede editar accidente --}}
...
@else
    ...
    <div class="alert alert-danger mt-4">
        No tienes permisos para editar accidentes.
    </div>
